...
if ($vista == "login" || $vista == "404" ||$vista == "UpdatePassword" ) {
   ...
   if($vista != "./src/view/imprimir-movimiento.php" && $vista != "./src/view/reporte-bienes.php" && $vista != "./src/view/imprimir-pdfs.php" && $vista != "./src/view/reporte-usuarios.php"&& $vista != "./src/view/reporte-instituciones.php"&& $vista != "./src/view/reporte-ambientes.php"&& $vista != "./src/view/reporte-movimientos.php"){
